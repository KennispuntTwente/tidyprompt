...
*To make it even easier to use ‘tidyprompt’, we are designing this
package to be compatible with the
[‘ellmer’](https://ellmer.tidyverse.org/index.html) R package, which has
gained popularity for interfacing with LLM APIs (see [more information
