...
This function generates an example JSON object from a JSON schema. This
is used when enforcing a JSON schema through text-based handling
...
- schema:
  ...
  A list (R object) representing a JSON schema
