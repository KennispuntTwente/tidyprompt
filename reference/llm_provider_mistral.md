...
object that interacts with the Mistral API.
...
- parameters:
  ...
  Mistral API documentation for more information:
...
- url:
  ...
  The URL to the Mistral API endpoint for chat completion

- api_key:

  The API key to use for authentication with the Mistral API

## Value

A new
[llm_provider](https://kennispunttwente.github.io/tidyprompt/reference/llm_provider-class.md)
object for use of the Mistral API
